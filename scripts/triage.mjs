...
- relevant: AI（人工知能）を対象とする法規制・ガイドライン・施行令・公的ガイダンス、またはAIの開発・利用に具体的に触れる規制当局の決定・執行か。AIに触れない一般の個人情報保護・通信・放送・生命科学・サイバー規制は false（AI固有の規定を含む場合だけ true）。ニュース解説のみ・製品発表・株価も false
